...
PRODUCT_COPY_FILES += \
    ...
    device/rockchip/rk3399pro/init.rk3399pro.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.rk3399pro.rc \
    device/rockchip/rk3399pro/init.rk30board.usb.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.rk30board.usb.rc \
...
#fireware for dp
PRODUCT_COPY_FILES += \
    device/rockchip/rk3399pro/dptx.bin:root/lib/firmware/rockchip/dptx.bin
